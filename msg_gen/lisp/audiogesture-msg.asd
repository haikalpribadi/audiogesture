...
(defsystem "audiogesture-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "PlayerCommand" :depends-on ("_package_PlayerCommand"))
    (:file "_package_PlayerCommand" :depends-on ("_package"))
    (:file "ProcessedOutput" :depends-on ("_package_ProcessedOutput"))
    (:file "_package_ProcessedOutput" :depends-on ("_package"))
    (:file "TrainerLogStatus" :depends-on ("_package_TrainerLogStatus"))
    (:file "_package_TrainerLogStatus" :depends-on ("_package"))
  ))
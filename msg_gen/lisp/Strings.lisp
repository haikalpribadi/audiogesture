...
(cl:defmethod cl:initialize-instance :after ((m <Strings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Strings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name audiogesture-msg:<Strings> is deprecated: use audiogesture-msg:Strings instead.")))

(cl:ensure-generic-function 'args-val :lambda-list '(m))
(cl:defmethod args-val ((m <Strings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader audiogesture-msg:args-val is deprecated.  Use audiogesture-msg:args instead.")
  (args m))

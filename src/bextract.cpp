...
//---------------------------------------------------------------------------------------------------------
void bextract_trainADRessStereoSPS(vector<Collection> cls, string classNames,
        string wekafname, mrs_natural memSize)
{
...
void bextract_train(vector<Collection> cls, Collection cl,
        mrs_natural label,
        string pluginName, string classNames,
        string wekafname,  mrs_natural memSize,
        string extractorStr,
...
void saivq_train_refactored(string pluginName,  string wekafname,
					   mrs_natural memSize, string classifierName,
					   mrs_bool single_vector)
{
...
int bextractor(vector<string> args)
{
  ...
  initOptions();
  cmd_options.readOptions(args.size(), cStringArray);
  loadOptions();
